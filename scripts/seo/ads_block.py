...
GROUPS = [
    ...
    {"key": "k6", "label": "Adobe", "match": "Adobe",
     "cpa_limit": 1500},
    # Раунд 2 (замечено 04.09 в выгрузке): четыре группы, заведённые в
    # кабинете после расширения, шли в письме одной строкой «прочие» и без
    # порога. Лимиты — по аналогии с сопоставимыми направлениями: агрегатор
    # спроса «зарубежное ПО» как ChatGPT (широкий верх воронки), Atlassian
    # как B2B-подписка, облака и Descript консервативнее по марже.
    # Уточняются решением руководителя.
    {"key": "k7", "label": "Зарубежное ПО (общая)", "match": "Зарубежное ПО",
     "cpa_limit": 2500},
    {"key": "k8", "label": "Atlassian", "match": "Atlassian",
     "cpa_limit": 3000},
    {"key": "k9", "label": "Box и Dropbox", "match": "Box и Dropbox",
     "cpa_limit": 1500},
    {"key": "k10", "label": "Descript", "match": "Descript",
     "cpa_limit": 1500},
]
