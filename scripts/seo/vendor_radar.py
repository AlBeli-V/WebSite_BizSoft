...
def build(snap: dict) -> dict:
    ...
    return {
        ...
        "note": ("Показы наших страниц по запросам с упоминанием вендора: "
                 "интерес аудитории в нашей выдаче, не рыночный спрос "
                 "(спрос измеряет Вордстат). Показы Яндекса и Google "
                 "не складываются."),
    }
