...
LIMITS = {
    ...
    # Запас взят с горизонтом: письмо 31.08 с переделанным контролем
    # эксперимента (разбор руководителя 31.08.2026 — внедрение/выдача/
    # экспозиция/старый→новый отдельными строками) заняло 1230 слов.
