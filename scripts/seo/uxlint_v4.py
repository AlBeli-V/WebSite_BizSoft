...
LIMITS = {
    # 1000 → 1100 с 29.08.2026: решением руководителя в письме появились две
    # постоянные секции — «Реклама (Директ)» и «Перспективные идеи». Сам блок
    # рекламы сжат до выжимки (детали — в веб-отчёте), но прежний потолок
    # физически не вмещал новый состав письма.
    "visible_words": 1100,
    "first_screen_words": 250,
    "kpi": 4,
    "signals": 3,
    "opportunities": 3,
    "board_rows": 5,
