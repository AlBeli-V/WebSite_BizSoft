#!/usr/bin/env python3
"""Слой отчётности v2 — ИСПОЛЬЗУЕТСЯ КАК БИБЛИОТЕКА (приложение и предыдущий срез).

Точка входа с 2026-08-19 — scripts/seo/report_v3.py. Прямой запуск этого файла оставлен
для отладки и совместимости; письмо руководителю собирает V3.
