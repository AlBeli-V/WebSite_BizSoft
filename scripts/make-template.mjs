...
const EXAMPLES = [
  ...
  },
  {
    ...
    base_price_usd: 100, base_price_eur: '', peg_currency: 'USD', markup_coeff: '', price_locked: 0,
  ...
  },
  {
    ...
    base_price_eur: 100, base_price_usd: '', peg_currency: 'EUR', markup_coeff: '', price_locked: 0,
...
const guide = [
  ...
  ['  рублёвая цена = себестоимость × курс ЦБ РФ на дату загрузки × коэффициент наценки (markup_coeff).'],
  ['• peg_currency — валюта закупки: USD или EUR. Если не указали, определяется по тому, какое из полей base_price_* заполнено.'],
  ['• markup_coeff — индивидуальный коэффициент наценки товара. Пусто = базовый коэффициент из настроек.'],
