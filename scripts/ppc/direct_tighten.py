...
Основание — статистика двух дней открутки (28.08 и 31.08, ops-direct-stats
в issue #22). EXACT-only автотаргетинг в группах вне Claude Code доказал
...
Чего пакет сознательно НЕ делает:
  - не минусует голый «claude code»: минус-фраза срезала бы и собственные
    ...
    в ops-direct-stats (отказы/глубина), решение после недели данных;
