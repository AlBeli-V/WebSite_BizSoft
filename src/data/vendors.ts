...
export const VENDORS: VendorEntry[] = [
  ...
  { slug: 'manageengine', vendor: 'ManageEngine', legalName: 'Zoho Corporation Pvt. Ltd. (ManageEngine)', brandColor: '#1D1D1F', site: 'https://www.manageengine.com', catSeg: 'system', catLabel: 'Системное ПО', domain: 'it',
    tagline: 'ServiceDesk Plus — служба поддержки и учёт ИТ-активов: годовые подписки на пакеты технических специалистов.',
    about: 'ManageEngine — линейка систем управления ИТ-инфраструктурой компании Zoho. Флагман для служб поддержки — ServiceDesk Plus: заявки пользователей, согласования, база решений и учёт того, что вообще стоит у компании на балансе. Лицензия считается не по числу сотрудников компании, а по числу технических специалистов, которые обрабатывают заявки, — обращаться в поддержку могут все.' },
