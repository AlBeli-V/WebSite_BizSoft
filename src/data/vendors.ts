...
export const VENDORS: VendorEntry[] = [
  ...
  { slug: 'perplexity', vendor: 'Perplexity', legalName: 'Perplexity AI, Inc.', brandColor: '#20808D', site: 'https://www.perplexity.ai', catSeg: 'ai', catLabel: 'AI-сервисы', domain: 'ai',
    tagline: 'AI-поиск с источниками: личные планы Pro и Max, командные Enterprise Pro и Enterprise Max с SSO и внутренними файлами.',
    about: 'Perplexity — поисковый AI-ассистент, который отвечает со ссылками на источники, а не по памяти модели. Личные планы Pro и Max закреплены за одним специалистом; командные Enterprise Pro и Enterprise Max оформляются на организацию и добавляют поиск по внутренним файлам компании, единый вход (SSO), журнал действий и запрет на обучение модели на ваших данных. Используется в аналитике рынка, конкурентной разведке и подготовке материалов, где ответ нужно проверить по первоисточнику.' },
  ...
  // Заведён 15.09.2026 по заданию руководителя: практическое обучение
  // кибербезопасности — первый вендор раздела «Обучение и киберполигоны».
  // Закупочные цены трёх тарифов названы руководителем (сайт вендора из
  // сессии недоступен — egress к tryhackme.com закрыт).
  { slug: 'tryhackme', vendor: 'TryHackMe', legalName: 'TryHackMe Ltd', brandColor: '#212C42', site: 'https://tryhackme.com', catSeg: 'training', catLabel: 'Обучение и киберполигоны', domain: 'it',
    tagline: 'Практическое обучение кибербезопасности в браузере: лаборатории, учебные пути и AttackBox. Личные тарифы Premium и MAX, командный Business.',
    about: 'TryHackMe — платформа практического обучения кибербезопасности: вместо лекций специалист работает в браузерных лабораториях («комнатах») с реальными уязвимостями, а задания собраны в учебные пути от основ до наступательной и оборонительной специализаций. Атакующая машина AttackBox запускается в браузере, поэтому своего стенда и локальной виртуалки не требуется. Личные тарифы открывают каталог обучения одному специалисту, командный Business добавляет консоль руководителя: назначение путей сотрудникам, отчёты о прогрессе и собственный учебный контент.' },
];
