...
export const UNIT_FORMS: Record<string, [string, string, string]> = {
  ...
  // Пакет мест: командный тариф, который вендор продаёт только целиком
  // (TryHackMe for Business — пять мест, 15.09.2026). Без формы призыв
  // сказал бы «Получить КП на 1 пакетов».
