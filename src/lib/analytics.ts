 ...
 * добавления в спецификацию и скачивания КП.
 *
...
export const GOALS: Record<string, GoalSpec> = {
  ...
  add_to_cart: { ga4: 'add_to_cart', key: false,
    meaning: 'Товар добавлен в спецификацию' },
  remove_from_cart: { ga4: 'remove_from_cart', key: false,
    meaning: 'Товар убран из спецификации' },
  view_cart: { ga4: 'view_cart', key: false,
    meaning: 'Открыта спецификация' },
  ...
  // спецификацией выглядит как отсутствие нажатия.
  quote_empty: { ga4: 'quote_empty', key: false,
    meaning: 'Нажали «Получить КП» с пустой спецификацией — форма не открылась' },
  ...
  home_shelf_cart: { ga4: 'view_cart', key: false,
    meaning: 'С полки спецификации открыли её состав' },
