...
## Отклонённые вендоры 29.08.2026 (решение руководителя, повторно не предлагать)

| Вендор | Причина | Примечание |
|---|---|---|
| NordVPN (и любые VPN-сервисы) | Реклама VPN-сервисов в России запрещена: штрафы и ответственность вплоть до статьи. Не заводить и не предлагать независимо от спроса. | Спрос в Вордстате был подтверждён, отклонён осознанно |
| Ansys | Цен на сайте вендора нет (quote-only); узкоспециализированное дорогое инженерное ПО, которое не покупают через магазин формата BIZSoft. | Спрос в Вордстате был подтверждён, отклонён осознанно |
