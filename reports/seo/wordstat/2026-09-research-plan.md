...
Сформирован 2026-09-02. Числа — оценка до вызовов.

## Что уже известно

- фраз в базе семантики: 23 047
- из них коммерческих: 2 145
- кластеров: 154, без страницы на сайте: 7
- спрос непокрытых кластеров: 33 914 показов в месяц
- уровни мониторинга: A — 48, B — 31, C — 75
...
- время прохода при 100 запросах в час: 0.4 ч
...
|---|---|---|---|---|---|
| 1 | getTop | lansweeper | discovery | 1.0 | 24.0 |
