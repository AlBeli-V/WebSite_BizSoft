# План исследований Вордстата — 2026-09

Сформирован 2026-09-04. Числа — оценка до вызовов.

## Что уже известно

- фраз в базе семантики: 23 122
- из них коммерческих: 2 147
- кластеров: 155, без страницы на сайте: 7
- спрос непокрытых кластеров: 33 914 показов в месяц
- уровни мониторинга: A — 48, B — 32, C — 75
...
| getTop | 135 | 2.70 ₽ |
| getDynamics | 4 | 0.08 ₽ |
| getRegionsDistribution | 48 | 2.40 ₽ |
| **Итого** | **187** | **5.18 ₽** |
...
- время прохода при действующей квоте (500 запросов в час): 0.4 ч
- при целевой квоте (500 в час): 0.4 ч
