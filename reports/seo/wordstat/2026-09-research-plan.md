...
Сформирован 2026-09-01. Числа — оценка до вызовов.

## Что уже известно

- фраз в базе семантики: 23 047
- из них коммерческих: 2 145
- кластеров: 153, без страницы на сайте: 8
- спрос непокрытых кластеров: 34 017 показов в месяц
- уровни мониторинга: A — 48, B — 32, C — 73
...
- время прохода при 100 запросах в час: 0.5 ч
