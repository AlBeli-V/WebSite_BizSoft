# План исследований Вордстата — 2026-08

Сформирован 2026-08-20. Числа — оценка до вызовов.

## Что уже известно

- фраз в базе семантики: 10 054
- из них коммерческих: 2 358
- кластеров: 129, без страницы на сайте: 39
- спрос непокрытых кластеров: 261 204 показов в месяц
- уровни мониторинга: A — 27, B — 40, C — 62
...
| getTop | 212 | 4.24 ₽ |
| getDynamics | 67 | 1.34 ₽ |
| getRegionsDistribution | 27 | 1.35 ₽ |
| **Итого** | **306** | **6.93 ₽** |
...
| 29 | getTop | docker купить | vendor_expansion | 0.6 | 16.8 |
| 30 | getTop | datadog купить | vendor_expansion | 0.6 | 16.8 |
