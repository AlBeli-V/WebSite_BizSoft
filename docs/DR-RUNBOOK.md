...
> Ночное расписание `ops-backup` включено 26.08.2026: копия снимается сама
> каждую ночь в 03:30 МСК, и заявленный RPO в 24 часа с этого момента
> обеспечен. Учебное восстановление из облачной копии на чистой машине пока
> не проводилось — до первой такой тревоги (§9) время из строки «RTO, потеря
