...
| 3 (готово, патч 6, партия 68) | Zoom, TeamViewer, AnyDesk (12); Atlassian, Slack, Notion, Miro, Dropbox, Box (15); Docker, GitLab, GitHub Copilot, Postman, Sentry, BrowserStack, n8n, Cloudflare, Cursor, Windsurf (22); Canva, Grammarly, DeepL, Framer, Sketch, Zeplin, Gamma (19). ManageEngine сеть (17) и данные/MDM (16) из патча 6 отброшены — те же 33 карточки уже слиты волной 1 (#545) | 68 | краткие профили 26 SaaS-вендоров |
