...
Копию базы Directus, медиатеки и секретов прода снимает workflow `ops-backup`
(запуск только с ветки `main`; расписание включается после первых успешных
ручных прогонов): архив в `/opt/bizsoft/backups` плюс шифрованная копия в
